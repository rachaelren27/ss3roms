...
1973 1982 1983 1992 1993 2002 2003 2010 2011 2014 # For selectivities of all fleets
2003 2009 2010 2010 2011 2014 # For retention of winter fleets
2003 2008 2009 2010 2011 2014 # For retention of summer fleets
...
0.005   0.50    0.145  -1.888         3  0.3333  6       0       0       0           0       0.5         0       0           #1 F_M_young
10      45      15.8    17.18        -1  10      2       0       0       0           0       0.5         0       0           #2 F_L@Amin (Amin is age entered above)
35      80      54.4     58.7        -1  10      3       0       0       0           0       0.5         0       0           #3 F_L@Amax
0.04    0.5     0.13     0.13        -1  0.8     2       0       0       0           0       0.5         0       0           #4 F_VBK
0.01    1.00    0.19      3.0        -1  0.8     3       0       0       0           0       0.5         0       0           #5 CV@LAAFIX
0.01    1.0     0.03      0.0        -1  1       4       0       0       0           0       0           0       0           # CV@LAAFIX2
#GP_1:::Male (Direct Estimation)
0.005   0.60    0.15   -1.580         3  0.3326  6       0       0       0           0       0.5         0       0           #1 M_M_young
10      45      16.6    17.18        -1  10      2       0       0       0           0       0.5         0       0           #2 M_L@Amin (Amin is age entered above)
35      80      43.2     58.7        -1  10      3       0       0       0           0       0.5         0       0           #3 M_L@Amax
0.04    0.5     0.20     0.13        -1  0.8     2       0       0       0           0       0.5         0       0           #4 M_VBK
0.01    1.00    0.14      3.0        -1  0.8     3       0       0       0           0       0.5         0       0           #5 M_CV@LAAFIX
0.01    1.0     0.05      0.0        -1  1       4       0       0       0           0       0           0       0           # M_CV@LAAFIX2
#LW_female
#LO     HI      INIT        PRIOR       PR_type SD  PHASE   env-var use_dev dev_minyr dev_maxyr dev_stddev  Block   Block_Fxn
...
5       20  9.64    9       -1      10     1      #Ln(R0)
0.2     1   0.90    0.8      0      0.09   5      #steepness(h)
...
15      75  46.6    43.1     -1      5   1  0   0   0   0   0.5  1   1   #PEAK (see Selex24.xls)
-5      3   3.0      0.7     -1      5  -3  0   0   0   0   0.5  0   0   #TOP (see Selex24.xls)
-4      12  3.9     3.42     -1      5   2  0   0   0   0   0.5  0   0   #ASC_WIDTH (see Selex24.xls)
...
#RETENTION 
10      40  26.19     15     -1      9   1  0   0   0   0   0    2   1   # Retain_1 Inflection
0.1     10  1.701      3     -1      9   2  0   0   0   0   0    2   1   # Retain_2 Slope
0.001   1   0.9945     1     -1      9   4  0   0   0   0   0    2   1   # Retain_3 Asymptote
-10     10  0          0     -1      9  -2  0   0   0   0   0    0   0   # Retain_4 Male offset (additive)
#...DO_MALE (AS OFFSET) 
-15     15 -8.8        0     -1      5   3  0   0   0   0   0.5  0   0   #PEAK (see Selex24.xls)
-15     15 -1.1        0     -1      5   4  0   0   0   0   0.5  0   0   #ASC_WIDTH (see Selex24.xls)
...
#FEMALE
#LO     HI  INIT    PRIOR   PR_TYPE SD  PHASE   env-var use_dev dev_yr1 dev_yr2 dev_sd  nblks   blk_pat #
15      75  53.8     43.1    -1      5   1  0   0   0   0   0.5  1   1   #PEAK (see Selex24.xls)
-5      3   3.0      0.7     -1      5  -3  0   0   0   0   0.5  0   0   #TOP (see Selex24.xls)
-4      12  5.3      3.42    -1      5   2  0   0   0   0   0.5  0   0   #ASC_WIDTH (see Selex24.xls)
-2      15  14.0     0.21    -1      5  -3  0   0   0   0   0.5  0   0   #DSC_WIDTH (see Selex24.xls)
-15     5   -999     -8.9    -1      5  -4  0   0   0   0   0.5  0   0   #INIT (see Selex24.xls)
-5      5   -999     0.15    -1      5  -4  0   0   0   0   0.5  0   0   #FINAL (see Selex24.xls)
#RETENTION
10      40  30.679   15      -1      9   1  0   0   0   0   0    3   1   # Retain_1 Inflection
0.1     10  1.1278   3       -1      9   2  0   0   0   0   0    3   1   # Retain_2 Slope
0.001   1   0.9999   1       -1      9   4  0   0   0   0   0    3   1   # Retain_3 Asymptote
-10     10  0        0       -1      9  -2  0   0   0   0   0    0   0   # Retain_4 Male offset (additive)
#...DO_MALE (AS OFFSET)
-20     15  -13.7    0       -1     -5   3  0   0   0   0   0.5  0   0   #PEAK (see Selex24.xls)
-15     15  -1.9     0       -1     -5   4  0   0   0   0   0.5  0   0   #ASC_WIDTH (see Selex24.xls)
-15     15   0       0       -1      5  -4  0   0   0   0   0.5  0   0   #DSC_WIDTH (see Selex24.xls)
-15     15   0       0       -1      5  -4  0   0   0   0   0.5  0   0   #FINAL (see Selex24.xls)
-15     15   1       0       -1      5  -4  0   0   0   0   0.5  0   0   #APICAL SEL (see Selex24.xls)
...
#FEMALE
#LO     HI  INIT    PRIOR   PR_TYPE SD  PHASE   env-var use_dev dev_yr1 dev_yr2 dev_sd  nblks   blk_pat #
15      75  40.422   43.1    -1      5   1  0   0   0   0   0.5  1   1   #PEAK (see Selex24.xls)
-5      3   3.0      0.7     -1      5  -3  0   0   0   0   0.5  0   0   #TOP (see Selex24.xls)
-4      12  4.5999   3.42    -1      5   2  0   0   0   0   0.5  0   0   #ASC_WIDTH (see Selex24.xls)
-2      15  14.0     0.21    -1      5  -3  0   0   0   0   0.5  0   0   #DSC_WIDTH (see Selex24.xls)
-15     5   -999     -8.9    -1      5  -4  0   0   0   0   0.5  0   0   #INIT (see Selex24.xls)
-5      5   -999     0.15    -1      5  -4  0   0   0   0   0.5  0   0   #FINAL (see Selex24.xls)
#RETENTION
10      40  28.816   15      -1      9   1  0   0   0   0   0    2   1   # Retain_1 Inflection
0.1     10  1.1443    3      -1      9   2  0   0   0   0   0    2   1   # Retain_2 Slope
0.001   1   0.986     1      -1      9   4  0   0   0   0   0    2   1   # Retain_3 Asymptote
-10     10  0         0      -1      9  -2  0   0   0   0   0    0   0   # Retain_4 Male offset (additive)
#...DO_MALE (AS OFFSET)
-15     15  -14.995   0      -1      5   3  0   0   0   0   0.5  0   0   #PEAK (see Selex24.xls)
-15     15  -2.4591   0      -1      5   4  0   0   0   0   0.5  0   0   #ASC_WIDTH (see Selex24.xls)
-15     15   0        0      -1      5  -4  0   0   0   0   0.5  0   0   #DSC_WIDTH (see Selex24.xls)
-15     15   0        0      -1      5  -4  0   0   0   0   0.5  0   0   #FINAL (see Selex24.xls)
-15     15   1        0      -1      5  -4  0   0   0   0   0.5  0   0   #APICAL SEL (see Selex24.xls)
...
#FEMALE
#LO     HI  INIT    PRIOR   PR_TYPE SD  PHASE   env-var use_dev dev_yr1 dev_yr2 dev_sd  nblks   blk_pat #
15      75   43.0793 43.1    -1      5   1  0   0   0   0   0.5  1   1   #PEAK (see Selex24.xls)
-5      3    3.0     0.7     -1      5  -3  0   0   0   0   0.5  0   0   #TOP (see Selex24.xls)
-4      12   4.7717  3.42    -1      5   2  0   0   0   0   0.5  0   0   #ASC_WIDTH (see Selex24.xls)
-2      15   14.0    0.21    -1      5  -3  0   0   0   0   0.5  0   0   #DSC_WIDTH (see Selex24.xls)
-15     5   -999     -8.9    -1      5  -4  0   0   0   0   0.5  0   0   #INIT (see Selex24.xls)
-5      5   -999     0.15    -1      5  -4  0   0   0   0   0.5  0   0   #FINAL (see Selex24.xls)
#RETENTION
10      40   29.055   15     -1      9   1  0   0   0   0   0    3   1   # Retain_1 Inflection
0.1     10   0.976     3     -1      9   2  0   0   0   0   0    3   1   # Retain_2 Slope
0.001   1    0.9995    1     -1      9   4  0   0   0   0   0    3   1   # Retain_3 Asymptote
-10     10   0         0     -1      9  -2  0   0   0   0   0    0   0   # Retain_4 Male offset (additive)
#...DO_MALE (AS OFFSET)
-15     15  -11.004    0     -1      5   3  0   0   0   0   0.5  0   0   #PEAK (see Selex24.xls)
-15     15  -1.4400    0     -1      5   4  0   0   0   0   0.5  0   0   #ASC_WIDTH (see Selex24.xls)
-15     15   0         0     -1      5  -4  0   0   0   0   0.5  0   0   #DSC_WIDTH (see Selex24.xls)
-15     15   0         0     -1      5  -4  0   0   0   0   0.5  0   0   #FINAL (see Selex24.xls)
-15     15   1         0     -1      5  -4  0   0   0   0   0.5  0   0   #APICAL SEL (see Selex24.xls)
...
#FEMALE
#LO     HI  INIT    PRIOR   PR_TYPE SD  PHASE   env-var use_dev dev_yr1 dev_yr2 dev_sd  nblks   blk_pat #
15      61  35.8319   43.1   -1      5   1  0   0   0   0   0.5  0   0   #PEAK (see Selex24.xls)
-5      3   3.0       0.7    -1      5  -2  0   0   0   0   0.5  0   0   #TOP (see Selex24.xls)
-4      12  4.2596    3.42   -1      5   1  0   0   0   0   0.5  0   0   #ASC_WIDTH (see Selex24.xls)
-2      15  14.0      0.21   -1      5  -2  0   0   0   0   0.5  0   0   #DSC_WIDTH (see Selex24.xls)
-15     5   -999      -8.9   -1      5  -4  0   0   0   0   0.5  0   0   #INIT (see Selex24.xls)
-5      5   -999      0.15   -1      5  -4  0   0   0   0   0.5  0   0   #FINAL (see Selex24.xls)
#...DO_MALE (AS OFFSET)
-15     15  -3.7323    0     -1      5   2  0   0   0   0   0.5  0   0   #PEAK (see Selex24.xls)
...
#FEMALE
#LO     HI  INIT    PRIOR   PR_TYPE SD  PHASE   env-var use_dev dev_yr1 dev_yr2 dev_sd  nblks   blk_pat #
15      61  36.9845  43.1    -1      5   1  0   0   0   0   0.5  0   0   #PEAK (see Selex24.xls)
-5      3   3.0      0.7     -1      5  -2  0   0   0   0   0.5  0   0   #TOP (see Selex24.xls)
-4      12  4.6735   3.42    -1      5   1  0   0   0   0   0.5  0   0   #ASC_WIDTH (see Selex24.xls)
-2      15  14.0     0.21    -1      5  -2  0   0   0   0   0.5  0   0   #DSC_WIDTH (see Selex24.xls)
-15     5   -999    -8.9     -1      5  -4  0   0   0   0   0.5  0   0   #INIT (see Selex24.xls)
-5      5   -999     0.15    -1      5  -4  0   0   0   0   0.5  0   0   #FINAL (see Selex24.xls)
#...DO_MALE (AS OFFSET)
...
#FEMALE
#LO     HI  INIT    PRIOR   PR_TYPE SD  PHASE   env-var use_dev dev_yr1 dev_yr2 dev_sd  nblks   blk_pat #
15      61  43.5877  43.1     -1     5   1  0   0   0   0   0.5  0   0   #PEAK (see Selex24.xls)
-5      3   3.0      0.7      -1     5  -2  0   0   0   0   0.5  0   0   #TOP (see Selex24.xls)
-4      12  5.2029   3.42     -1     5   1  0   0   0   0   0.5  0   0   #ASC_WIDTH (see Selex24.xls)
-2      15  14.0     0.21     -1     5  -2  0   0   0   0   0.5  0   0   #DSC_WIDTH (see Selex24.xls)
-15     5   -999    -8.9      -1     5  -4  0   0   0   0   0.5  0   0   #INIT (see Selex24.xls)
-5      5   -999     0.15     -1     5  -4  0   0   0   0   0.5  0   0   #FINAL (see Selex24.xls)
#...DO_MALE (AS OFFSET)
-15     15  -5.8784  0        -1     5   2  0   0   0   0   0.5  0   0   #PEAK (see Selex24.xls)
-15     15  -0.4792  0        -1     5   2  0   0   0   0   0.5  0   0   #ASC_WIDTH (see Selex24.xls)
-15     15   0       0        -1     5  -3  0   0   0   0   0.5  0   0   #DSC_WIDTH (see Selex24.xls)
-15     15   0       0        -1     5  -3  0   0   0   0   0.5  0   0   #FINAL (see Selex24.xls)
-15     15   1       0        -1     5  -4  0   0   0   0   0.5  0   0   #APICAL SEL (see Selex24.xls)
...
6.26  2.21  1.83 1.60  1    1    0.22  #_mult_by_agecomp_N
